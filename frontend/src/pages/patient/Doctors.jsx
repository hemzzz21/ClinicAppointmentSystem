...
function Doctors() {
  ...
  return (
    <DashboardLayout>
      <PageHeader
        eyebrow="Find specialists"
        title="Choose the right doctor"
        subtitle="Search doctors by name or filter by specialization."
      />

      <section className="mt-8 grid gap-4 rounded-3xl border border-white/70 bg-white/75 p-5 shadow-sm backdrop-blur md:grid-cols-[1fr_260px]">
      ...
      {loading ? (
        ...
        <div className="mt-8">
          <EmptyState
            ...
            description="Try another search or specialization."
          />
        </div>
      ) : (
